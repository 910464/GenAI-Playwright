class PlaywrightJavascriptPrompts():
    def __init__(self):
        self.template_script_generate = """
               ...
               7. Only returning the playwright javascript test spec file without any formatting or code markers 
                   (e.g., no '''playwright, no backticks).
               8. Include comments of Functions.
               9. Use Base url from config file.
               10. Strictly Validate the responses: After each action, add playwright assertion step and promises for validations wherever needed to ensure that the action was successful.
        ...
        self.template_page_class = """
                ...
                9.Only returning the javascript file in playwright framework without any formatting or code markers 
                  (e.g., no '''playwright, no backticks)
        """
...
def tokenize_bdd(input_param, file_content):
    model = LLM()
    template_tc = """
            I am giving you a BDD Feature File as an input: 
            '{input}'

            Your FOCUS should be the steps in the scenario in the BDD FF only.

            Assume the role of an highly experienced tester and 
            follow the instructions below to identify and extract the following components:
            ...
            If action is 'Expand', replace it with 'Click'.
            ...
            STRICTLY Include ONLY the Phrase not the type of webpage element. 
            i.e. Instead of writing 'submit button', write ONLY 'submit'.
            i.e. Instead of writing 'Address input field', write ONLY 'Address'.

            If something is in quotes, then it should be taken as it is in the object.
            For instance:
            Click on " Find Home"
            Action: Click
            Object: " Find Home" 
            The point of this is to retain the leading or trailing spaces, if any.
            ...
            displayed in a XY Page as below: minimum duration added' the condition is 'is displayed in a XY Page' and 
            condition value is 'minimum duration added'. Ensure that condition_value phrases are listed below 'Condition_' column.
            ...
            Please provide your findings for each component based on the given instructions.
                ...
                WARNING: THIS IS THE MOST IMPORTANT RULE THAT YOU HAVE TO FOLLOW AT ALL COSTS 
                If something is written inside quotes then it should be taken as it is.
                    ==>Example:
                        Enter 12345 in the "Enter Zip, City or State" input field
                        PageClass|Action|Object|Test_Data|Condition|Condition_Value|extra|||
                        Homepage|Enter|"Enter Zip, City or State"|12345|||
            ...
            Make sure you return entire extracted data with pipe (|) separated format only and not the truncated dotted format response.
            Maintain the pipe separated value table sequence with STRICTLY 7 columns and add a header with column names as below:
            PageClass|Action|Object|Test_Data|Condition|Condition_Value|extra.
    ...
    validation_check = """
            ...
            I want you to validate this output given by LLM and do any corrections if needed and return pipe separate value data in same format.
            ...
            3. Object: This is Noun Phrase in sentence. 
               It should not contain web element names like button, option, input field, etc.
            ...
            Return ONLY pipe separated value format without any formatting or code markers (e.g., no ''', no psv, no backticks). DON'T give any explanation
            """
